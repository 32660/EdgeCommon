...
var file_models_model_http_access_log_policy_proto_goTypes = []interface{}{
...
func file_models_model_http_access_log_policy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_models_model_http_access_log_policy_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
