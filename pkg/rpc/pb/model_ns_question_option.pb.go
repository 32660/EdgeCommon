...
type NSQuestionOption struct {
	...
	ValuesJSON []byte `protobuf:"bytes,3,opt,name=valuesJSON,proto3" json:"valuesJSON,omitempty"`
}

func (x *NSQuestionOption) Reset() {
	*x = NSQuestionOption{}
	if protoimpl.UnsafeEnabled {
		mi := &file_models_model_ns_question_option_proto_msgTypes[0]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *NSQuestionOption) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NSQuestionOption) ProtoMessage() {}

func (x *NSQuestionOption) ProtoReflect() protoreflect.Message {
	mi := &file_models_model_ns_question_option_proto_msgTypes[0]
...
// Deprecated: Use NSQuestionOption.ProtoReflect.Descriptor instead.
func (*NSQuestionOption) Descriptor() ([]byte, []int) {
	return file_models_model_ns_question_option_proto_rawDescGZIP(), []int{0}
}

func (x *NSQuestionOption) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *NSQuestionOption) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *NSQuestionOption) GetValuesJSON() []byte {
	if x != nil {
		return x.ValuesJSON
	}
	return nil
...
var file_models_model_ns_question_option_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_models_model_ns_question_option_proto_goTypes = []interface{}{
	(*NSQuestionOption)(nil), // 0: pb.NSQuestionOption
}
var file_models_model_ns_question_option_proto_depIdxs = []int32{
...
func init() { file_models_model_ns_question_option_proto_init() }
func file_models_model_ns_question_option_proto_init() {
	if File_models_model_ns_question_option_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_models_model_ns_question_option_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NSQuestionOption); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_models_model_ns_question_option_proto_goTypes,
		DependencyIndexes: file_models_model_ns_question_option_proto_depIdxs,
