...
var file_models_model_http_firewall_rule_set_proto_goTypes = []interface{}{
...
func file_models_model_http_firewall_rule_set_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_models_model_http_firewall_rule_set_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HTTPFirewallRuleSet); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
