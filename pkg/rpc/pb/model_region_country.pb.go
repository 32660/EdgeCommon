...
var file_models_model_region_country_proto_goTypes = []interface{}{
...
func file_models_model_region_country_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_models_model_region_country_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RegionCountry); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
