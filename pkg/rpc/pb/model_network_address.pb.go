...
var file_models_model_network_address_proto_goTypes = []interface{}{
...
func file_models_model_network_address_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_models_model_network_address_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
