...
func (x *NodeLogin) Reset() {
	*x = NodeLogin{}
	if protoimpl.UnsafeEnabled {
		mi := &file_models_model_node_login_proto_msgTypes[0]
...
func (*NodeLogin) Descriptor() ([]byte, []int) {
	return file_models_model_node_login_proto_rawDescGZIP(), []int{0}
}
...
var file_models_model_node_login_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_models_model_node_login_proto_goTypes = []interface{}{
	(*NodeLogin)(nil), // 0: pb.NodeLogin
}
var file_models_model_node_login_proto_depIdxs = []int32{
...
func init() { file_models_model_node_login_proto_init() }
func file_models_model_node_login_proto_init() {
	if File_models_model_node_login_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_models_model_node_login_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_models_model_node_login_proto_goTypes,
		DependencyIndexes: file_models_model_node_login_proto_depIdxs,
