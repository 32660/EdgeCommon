...
var file_models_model_db_node_proto_goTypes = []interface{}{
...
func file_models_model_db_node_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_models_model_db_node_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DBNode); i {
			case 0:
				return &v.state
			case 1:
		...
		file_models_model_db_node_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
