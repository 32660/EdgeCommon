...
func (x *ReportNodeGroup) Reset() {
	*x = ReportNodeGroup{}
	if protoimpl.UnsafeEnabled {
		mi := &file_models_model_report_node_group_proto_msgTypes[0]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ReportNodeGroup) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReportNodeGroup) ProtoMessage() {}

func (x *ReportNodeGroup) ProtoReflect() protoreflect.Message {
	mi := &file_models_model_report_node_group_proto_msgTypes[0]
...
// Deprecated: Use ReportNodeGroup.ProtoReflect.Descriptor instead.
func (*ReportNodeGroup) Descriptor() ([]byte, []int) {
	return file_models_model_report_node_group_proto_rawDescGZIP(), []int{0}
}

func (x *ReportNodeGroup) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *ReportNodeGroup) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ReportNodeGroup) GetIsOn() bool {
	if x != nil {
		return x.IsOn
	}
	return false
...
var file_models_model_report_node_group_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_models_model_report_node_group_proto_goTypes = []interface{}{
	(*ReportNodeGroup)(nil), // 0: pb.ReportNodeGroup
}
var file_models_model_report_node_group_proto_depIdxs = []int32{
...
func init() { file_models_model_report_node_group_proto_init() }
func file_models_model_report_node_group_proto_init() {
	if File_models_model_report_node_group_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_models_model_report_node_group_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReportNodeGroup); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_models_model_report_node_group_proto_goTypes,
		DependencyIndexes: file_models_model_report_node_group_proto_depIdxs,
