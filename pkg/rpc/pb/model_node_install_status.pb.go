...
var file_models_model_node_install_status_proto_goTypes = []interface{}{
...
func file_models_model_node_install_status_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_models_model_node_install_status_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
